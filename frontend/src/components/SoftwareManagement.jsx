  ...
  const handleToggleStatus = async (id, currentStatus) => {
    try {
        ...
        const response = await axios.patch(
            `${import.meta.env.VITE_API_BASE_URL}/api/software/toggle-status/${id}`,
            {},
            { headers: { Authorization: `Bearer ${token}` } }
        );
                    ...
                    <tr key={software._id}>
                      ...
                      <td>
                        <label className="switch">
                            <input
                                type="checkbox"
                                checked={software.isActive !== undefined ? software.isActive : true}
                                onChange={() => handleToggleStatus(software._id, software.isActive)}
                            />
